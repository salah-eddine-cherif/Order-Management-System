                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="flex flex-col mt-16">
                        ...
                        <motion.p className="text-lg py-6"
                            ...
                            animate="visible"
                        >
                            It is of paramount significance for the discerning patron to immerse themselves in the intricacies of the fabricating journey.
                            Those who navigate the labyrinth of thought, wrestling with the ephemeral whims of aspiration and discontent, shall inevitably encounter the revelation that, forged by the diligent, resolute spirit, the architects of this endeavor shall rise as luminaries.
                            The tapestry of creation is woven with threads of perseverance, and thus it unfolds, illuminating the path for the seekers who dare to dream.
                        </motion.p>
                        <motion.div
                    ...
                    >
                        <img className="h-[100%]" src={HERO_URL} alt="" />
                    </motion.div>
                </div>
            </div>
        </div>

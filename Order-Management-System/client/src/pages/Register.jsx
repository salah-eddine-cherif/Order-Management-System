...
const Register = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      password: Yup.string().matches(passwordRules, { message: "Please create a stronger password,  min 5 characters, 1 upper case letter, 1 lower case letter, 1 numeric digit." }).required("Required"),
